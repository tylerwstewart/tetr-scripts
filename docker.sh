...
TAG_DOCKER_90="9.0-x86"
TAG_DOCKER_100="10.0-x86"
TAG_DOCKER_100_64="10.0-x86_64"
TAG_DOCKER_CURRENT="$TAG_DOCKER_100"
TAG_DOCKER_CURRENT_64="$TAG_DOCKER_100_64"
#TETR_TAG="$TAG_DOCKER_CURRENT"
TETR_TAG="$TAG_DOCKER_CURRENT_64"
DOCKER_IMAGE="tylerwstewart/tetr:$TETR_TAG"
